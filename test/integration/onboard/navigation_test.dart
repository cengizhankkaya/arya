...
void main() {
  group('Onboard Navigation Integration Tests', () {
    ...
    testWidgets('OnboardController test ortamında oluşturulabilmeli', (tester) async {
    ...
    testWidgets('OnboardController başlangıç durumu doğru olmalı', (tester) async {
      // ARRANGE: OnboardController oluştur
      final controller = OnboardController();
    ...
    testWidgets('OnboardController son sayfa durumu doğru olmalı', (tester) async {
      // ARRANGE: OnboardController oluştur
      final controller = OnboardController();
    ...
    testWidgets('OnboardController back enabled property doğru çalışmalı', (tester) async {
      // ARRANGE: OnboardController oluştur
      final controller = OnboardController();
    ...
    testWidgets('OnboardController index bounds kontrolü doğru olmalı', (tester) async {
      // ARRANGE: OnboardController oluştur
      final controller = OnboardController();
